...
/**********************************************************************************************************************
 Macro definitions
 *********************************************************************************************************************/
#define OSTM0CMP_0    ((volatile uint32_t *)( RZG3L_GTM_0_BASE + 0x000 ))  /* OSTM compare register_0 */
#define OSTM0CNT_0    ((volatile uint32_t *)( RZG3L_GTM_0_BASE + 0x004 ))  /* OSTM counter register_0 */
#define OSTM0TE_0     ((volatile uint8_t *) ( RZG3L_GTM_0_BASE + 0x010 ))  /* OSTM count enable status register_0 */
#define OSTM0TS_0     ((volatile uint8_t *) ( RZG3L_GTM_0_BASE + 0x014 ))  /* OSTM count start trigger register_0 */
#define OSTM0TT_0     ((volatile uint8_t *) ( RZG3L_GTM_0_BASE + 0x018 ))  /* OSTM count stop trigger register_0 */
#define OSTM0CTL_0    ((volatile uint8_t *) ( RZG3L_GTM_0_BASE + 0x020 ))  /* OSTM control register_0 */

#define OSTM_1MS_COUNT ( 100000 + 1 )    /* Counter value per 1ms */
#define OSTM_1US_OCUNT ( 100 + 1 )       /* Counter value per 1us */
