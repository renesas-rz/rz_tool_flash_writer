...
static void decode_streaming_message_lpddr4_2d(uint32_t codede_message_hex, uint16_t *args_list);
...
static void decode_streaming_message(uint8_t sel_train)
{
	...
	case 3:
		...
		break;
	case 4:
		decode_streaming_message_lpddr4_2d(codede_message_hex, args_list);
		break;
	}
}
...
static void decode_streaming_message_lpddr4_2d(uint32_t codede_message_hex, uint16_t *args_list)
{
	...
	// 	break;
	// case 0x00910001:
	// 	INFO("PMU5: Strong 1, pull-up %d ohms\n", args_list[0]);
	// 	break;
	// case 0x00920001:
	// 	INFO("PMU5: Strong 0, pull-down %d ohms\n", args_list[0]);
	// 	break;
	// case 0x00930000:
	...
	// 	break;
	// default:
		// INFO("PMU Streaming Msg: Debug message not recognized !!  code: %x\n", codede_message_hex);
		// panic();
	}
#endif
}
